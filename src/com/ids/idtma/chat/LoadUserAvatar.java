...
import com.ids.idtma.util.BitmapCache;
import com.ids.idtma.util.FileUtil;
import com.ids.idtma.util.HTTPService;
...
public class LoadUserAvatar {
    ...
    public Bitmap loadImage(final ImageView imageView, final String imageUrl,
        ...
        if (bitmap != null) {
            LwtLog.i("aaaa", "image exists in memory");
        ...
        if (fileUtil.isBitmapExists(filename)) {
            LwtLog.i("aaaa", "image exists in file" + filename);
        ...
        if (imageUrl != null && !imageUrl.equals("")) {
            ...
            Thread thread = new Thread() {
                ...
                @Override
                public void run() {
                    LwtLog.i("aaaa", Thread.currentThread().getName()
                            + " is running");
